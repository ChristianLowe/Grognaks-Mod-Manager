Drop any .ftl files here and restart modman.exe in order to be able to patch them in.

Mods are loaded by the order they're in with modorder.txt. Keep that in mind in case of conflicts.
