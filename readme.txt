...
Developer Notes
  ...
  The root of the ZIP file should contain one or more of these folders:
    ...
    You should ONLY put in the files that you have modified. This helps keep
  ...
  possible. As a rule of thumb, if you're editing an event xml file, you're
  going to want to append your changes rather then flat out replace the
  file. Keep in mind that you can override vanilla events to your pleasure
  by having the same event name, and using .append helps prevent mod
  conflict.
  ...
  Unless you're overriding something, try to use unique unique names in your
  xml so that it won't clobber another mod and vice versa.
